...
using DotnetApiTemplate.DataAccess.Repositories;
using DotnetApiTemplate.Domain.Repositories;
using DotnetApiTemplate.Domain.UnitOfWork;

namespace DotnetApiTemplate.DataAccess.UnitOfWork;
...
{
    private readonly DotnetApiTemplateContext _context;
    ...
    public UnitOfWork(DotnetApiTemplateContext context)
    {
